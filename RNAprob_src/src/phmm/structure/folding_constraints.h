...
public:
	...
	//static int** compute_paired_ptr_reloc_map(t_structure* rna_seq, double pp_threshold, double** pairing_probs);
	//static int** compute_coinc_ptr_reloc_map(t_structure* rna_seq, double pp_threshold, double** pairing_probs);
	//static int** compute_paired_ptr_reloc_map(char* seq_fp, double pp_threshold, double** pairing_probs);
	//static int** compute_coinc_ptr_reloc_map(char* seq_fp, double pp_threshold, double** pairing_probs);
	int** coinc_pointer_relocation_map; // Use to allocate unpaired (only co-incident locations)
	int** paired_pointer_relocation_map; // Use to allocate paired arrays.
