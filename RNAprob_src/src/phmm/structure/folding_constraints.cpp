...
t_folding_constraints::t_folding_constraints(t_folding_constraints* _folding_constraints)
{
	...
	{
		this->coinc_pointer_relocation_map = (int**)malloc(sizeof(int*) * (rna_seq->numofbases + 3));
		this->paired_pointer_relocation_map = (int**)malloc(sizeof(int*) * (rna_seq->numofbases + 3));

		for(int i = 1; i <= rna_seq->numofbases; i++)
		{
			coinc_pointer_relocation_map[i] = (int*)malloc(sizeof(int) * (rna_seq->numofbases - i + 3));
			coinc_pointer_relocation_map[i] -= i; // Do pointer shift for fold envelope.

			paired_pointer_relocation_map[i] = (int*)malloc(sizeof(int) * (rna_seq->numofbases - i + 3));
...
//int** t_folding_constraints::compute_coinc_ptr_reloc_map(char* seq_fp, double pp_threshold, double** pairing_probs)
//{
//	t_structure* rna_seq = new t_structure(seq_fp);
//	int** coinc_ptr_reloc_map = t_folding_constraints::compute_coinc_ptr_reloc_map(rna_seq, pp_threshold, pairing_probs);
//	delete(rna_seq);
//	return(coinc_ptr_reloc_map);
//}
//
//int** t_folding_constraints::compute_paired_ptr_reloc_map(char* seq_fp, double pp_threshold, double** pairing_probs)
//{
//	t_structure* rna_seq = new t_structure(seq_fp);
//	int** paired_ptr_reloc_map = t_folding_constraints::compute_paired_ptr_reloc_map(rna_seq, pp_threshold, pairing_probs);
//	delete(rna_seq);
...
//int** t_folding_constraints::compute_paired_ptr_reloc_map(t_structure* rna_seq, double pp_threshold, double** pairing_probs)
//{
//	printf("Generating ptr reloc maps with threshold %lf\n", pp_threshold);
//
//	// Generate pointer relocation maps.
//	int** paired_pointer_relocation_map = (int**)malloc(sizeof(int*) * (rna_seq->numofbases + 3));
//
//	for(int i = 1; i <= rna_seq->numofbases; i++)
//	{
//		paired_pointer_relocation_map[i] = (int*)malloc(sizeof(int) * (rna_seq->numofbases - i + 3));
...
//}
//
//int** t_folding_constraints::compute_coinc_ptr_reloc_map(t_structure* rna_seq, double pp_threshold, double** pairing_probs)
//{
//	printf("Generating ptr reloc maps with threshold %lf\n", pp_threshold);
//
//	// Generate pointer relocation maps.
//	int** coinc_pointer_relocation_map = (int**)malloc(sizeof(int*) * (rna_seq->numofbases + 3));
//
//	for(int i = 1; i <= rna_seq->numofbases; i++)
//	{
//		coinc_pointer_relocation_map[i] = (int*)malloc(sizeof(int) * (rna_seq->numofbases - i + 3));
