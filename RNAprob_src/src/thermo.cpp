		...
		for (j=1;j<=4;j++) {
			for (l=1;l<=4;l++) {
					...
					if (strcmp(lineoftext,".")){
						dh[i][j][k][l] =(int) floor(conversionfactor*(atof(lineoftext))+.5);
					}
	...
	for (k=1;k<=4;k++) {
		for (j=1;j<=4;j++) {
			for (l=1;l<=4;l++) {
					dsf >> lineoftext;
					if (strcmp(lineoftext,".")){
						ds[i][j][k][l] =(int) floor(conversionfactor*(atof(lineoftext))+.5);
					}
...
hf >> lineoftext;
dhi = (int) floor(conversionfactor*(atof(lineoftext))+.5);
for (count = 1;count <=4;count++) hf >> lineoftext;
hf >> lineoftext;
dsi = (int) floor(conversionfactor*(atof(lineoftext))+.5);
for (count = 1;count <=5;count++) hf >> lineoftext;
hf >> lineoftext;
dss = (int) floor(conversionfactor*(atof(lineoftext))+.5);
for (count = 1;count <=5;count++) hf >> lineoftext;
hf >> lineoftext;
dha = (int) floor(conversionfactor*(atof(lineoftext))+.5);
for (count = 1;count <=5;count++) hf >> lineoftext;
hf >> lineoftext;
dsa = (int) floor(conversionfactor*(atof(lineoftext))+.5);
