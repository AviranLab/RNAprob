...
//FD
#define INFINITE_ENERGY 16000000  //an arbitrary value given to infinity
#define maxtloop 200 //maximum tetraloops allowed (info read from tloop, triloop, and hexaloop)
//FD
#define DYNALIGN_INFINITY 16000000  //an arbitrary value given to infinity
...
//FD
#define integersize int //#define integersize short
#define DIGITS "%.1f"
...
enum StructureType{STYPE_ALL, STYPE_UNPAIRED, STYPE_PAIRED, STYPE_HELIXEND, STYPE_STACKED, NUM_STYPE};
enum DataSource{DSOURCE_SHAPE, DSOURCE_DMS, NUM_DSOURCE};
enum BaseType{BASE_A, BASE_C, BASE_G, BASE_U, BASE_X, NUM_BASE};
