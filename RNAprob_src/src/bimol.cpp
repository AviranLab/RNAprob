...
void bimoltracebackV(int i, int j, int jct3, int k, int N1, int N2, int maxloop, int **V, structure *ct3, datatable *data);
void bimoltracebackVp(int i, int j, int jct3, int k, int N1, int N2, int maxloop, int **Vp, structure *ct3, datatable *data);
