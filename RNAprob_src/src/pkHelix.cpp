...
pkHelix::pkHelix(datatable *data, structure *st, int size, int *helixList){
	//4 argument constructor that builds a new object from a pre-existing array of ints
	helix = new int[size];
	length = size;
	//0 is base-paired to 1, 2 is basepaired to 3, etc.
	//0,2,4,6 is five prime half of helix
