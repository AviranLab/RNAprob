...
int ebp(int i,int j,int ip,int jp,structure *ct, datatable *data);
...
int iref(int i, int j, int N);
int jref(int i, int j, int N);
int ideref(int i, int j, int N);
int jderef(int i, int j, int N);
...
void dynalignforce(structure *ct1, structure *ct2,
                   /*int ****fce,*/ char **fce1, char **fce2, bool *dbl1, 
...
int dynalign(structure *ct1, structure *ct2, int **alignment,
             int maxseparation, int islope, int iintercept, int gapincrease, datatable *data, 
              int maxtracebacks, int window, int awindow, int percentsort, int **forcealign, int max_elongation,bool **allowed_alignments=NULL, 
              TProgressDialog *progress=NULL, const char *Savefile=NULL,
              bool energyonly = false, bool local = false, bool force = false, int numProcessors = 1);
#else
int dynalign(structure *ct1, structure *ct2, int **alignment,
              int maxseparation, int gapincrease, datatable *data, bool singleinsert, 
              int maxtracebacks, int window, int awindow, int percentsort, int **forcealign, bool **allowed_alignments=NULL, 
              TProgressDialog *progress=NULL, const char *Savefile=NULL,
              bool energyonly = false, bool local = false, bool force = false, int numProcessors = 1);
#endif
...
void dynalignstep(structure *ct1, structure *ct2, datatable *data, varray *v, dynalignarray *w, wendarray *w5, wendarray *w3,  
                  ...
                  char **fce1, char **fce2, bool alignmentforced, int **forcealign, bool *dbl1, bool *dbl2,int max_elongation,
...
void dynalignstep(structure *ct1, structure *ct2, datatable *data, varray *v, dynalignarray *w, wendarray *w5, wendarray *w3,  
                  ...
                  char **fce1, char **fce2, bool alignmentforced, int **forcealign, bool *dbl1, bool *dbl2,  
                  int i, int j, int k, int l, int N, int N2,
...
int dyntrace(int i, int j, int a, int b, structure *ct1, structure *ct2,
	     ...
	     char **fce1, char **fce2, bool alignmentforced, int **forcealign,bool force,bool startopen=false);
...
void opendynalignsavefile(const char *filename, structure *ct1, structure *ct2,
                          ...
                          int *max_elongation, int *maxsep, int *islope, int *iintercept, int *gap,
...
int traceback_debugger(const char* filename, structure *ct1, structure *ct2,int i,int j,int k,int l, int **alignment, int maxtracebacks,
		       int window, int awindow, int percentsort,bool forced,int** forcealign,bool outer);
...
inline int ebp(int i,int j,int ip,int jp,structure *ct, datatable *data) {
  return data->stack[(ct->numseq[i])][(ct->numseq[j])]
    [(ct->numseq[ip])][(ct->numseq[jp])];
}

inline int iref(int i, int j, int N) {
  if (j<=N) return i;
  else {
    if (i>N) return i-N;
    else return (i-j+N);
...
inline int jref(int i, int j, int N) {
  if (i>N) return (j-N);
  else return j;
}

inline int ideref(int i, int j, int N) {
  if (i>N&&j>N) return i-N;
  else return i;
}

inline int jderef(int i, int j, int N) {
